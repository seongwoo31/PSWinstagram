...
import com.psw.pswinstagram.navigation.model.AlarmDTO;
...
public class DetailAdapter extends RecyclerView.Adapter<DetailAdapter.ViewHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull DetailAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
